...
<html>
  ...
  <input id="username" name="username" type="text" class="form-control" minlength="3" maxlength="12" <?php if(!empty($_GET['username'])){echo 'value="'.$_GET['username'].'"';};?> required placeholder="请输入您的姓名"/>
  </div>
		<button type="submit" class="button button-3d button-primary button-rounded">登录</button>
        </form>
		</center>
	</body>
</html>
